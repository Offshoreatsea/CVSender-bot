...
POSITION_GROUPS = [
    ...
    ('⚓ Торговый · Engine Officers', [
        ...
        ('JuniorEngineer|Merchant', 'Junior Engineer'),
        ('RefEngineer|Merchant', 'Ref Engineer'),
        ('ETO|Merchant', 'ETO'),
    ...
    ('⚓ Торговый · Bridge Officers (Offshore)', [
        ...
        ('SecondOfficer|Offshore', '2nd Officer'),
        ('ThirdOfficer|Offshore', '3rd Officer'),
    ...
    ('⚓ Торговый · Engine Officers (Offshore)', [
        ...
        ('JuniorEngineer|Offshore', 'Junior Engineer'),
        ('ETO|Offshore', 'ETO'),
    ...
    ('⚓ Торговый · Deck Ratings (Offshore)', [
        ...
        ('Roustabout|Offshore', 'Roustabout'),
        ('CraneOperator|Offshore', 'Crane Operator'),
        ('GangwayOperator|Offshore', 'Gangway Operator'),
        ('HLO|Offshore', 'HLO'),
        ('Rigger|Offshore', 'Rigger'),
        ('Fitter|Offshore', 'Fitter'),
    ...
    ('🛢 Танкера · Engine Officers', [
        ...
        ('JuniorEngineer|Tanker', 'Junior Engineer'),
        ('RefEngineer|Tanker', 'Ref Engineer'),
        ('ETO|Tanker', 'ETO'),
...
async def run_test_mail(bot: Bot, client) -> str:
    try:
        msg = await build_message(
            bot, client, client["email"], "Test – CV Sender job applications",
...
HELP_TEXT = (
    ...
    "<b>Подбор вакансий:</b>\n"
    "• Должность выбирается ОТДЕЛЬНО в каждом флоте (Merchant/Offshore/Tanker) — "
    "это разные подписки, как и в основном боте.\n"
    "• В офшоре Master = Master / SDPO (одна воронка, SDPO — то же самое, "
    "просто с DP-допуском).\n"
    "• Синонимы в названии должности (Mate/OOW → 2nd Officer, «Engineer»/EOOW "
